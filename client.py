...
class Client:
	...
	#Nodes receives new messages from other nodes
	...
	#Here, finger table is updated after a node joins or leave
	...
	#When a node leaves, this function is called to inform others and finger table updation
	def onClosing(self):
		self.editNotepad = 0
	...
	#this function passes message to other nodes
	...
	#this function passes message to its predeccesor
	...
	#this function forward the updated texts to all its neighbour in finger table	
	...
	#closing connection with a node
	...
	#It retrieves all the file names from server
	...
	#Here it sends request to connect to a group of nodes with a document
